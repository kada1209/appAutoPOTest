 ...
 * 初始化app信息
 * @author wangxinqi
 * @date 2019-04-02 20:53
 */
@Listeners({base.AssertionListener.class})
public class InitAppium {
    //调试设备名字
    public static String deviceName = "小米MIX2";
    //调试设备系统版本
    public static String platformVersion = "8.0.0";
    //app路径
    public static String appPath = System.getProperty("user.dir") + "/src/main/java/apps/kada_v4.0.20_guanwang_release.apk";

    //包名
    public static String appPackage = "com.hhdd.kada";
    ...
    public static String appActivity = ".main.ui.activity.LaunchActivity";
